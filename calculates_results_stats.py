...
def calculates_results_stats(results_dic):
    ...
    # Traverse through results_dic dictionary to recompute the statistics outside of the calculates_results_stats() function
    for key in results_dic:
        # match (if dog then breed match)
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1
            
            # dog pet label && breed match
            if results_dic[key][3] == 1:
                results_stats_dic['n_dogs_img'] += 1
                
                # dog classifier label && breed match
    ...
    # calculateing the stat based upon counters from above
